...
/**
 * How bytes on a topic become an {@link com.example.notification.event.OrderPlaced}.
 *
 ...
 * not have, because its own copy lives in {@code com.example.notification.event}. The fix people reach
