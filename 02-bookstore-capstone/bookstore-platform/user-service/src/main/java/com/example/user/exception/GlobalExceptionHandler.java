...
public class GlobalExceptionHandler {
    ...
    /*
     * The monolith's handler for InsufficientStockException is gone from here. Stock is a catalog
     * concept, and this service now has no books, no stock, and no reason to know the word. The split
     * makes that obvious in a way the single shared handler never did — every exception now has to
     * belong to exactly one service, and the compiler enforces it.
     */
